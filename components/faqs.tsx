  ...
  return (
    <Container className="border-divide flex flex-col items-center border-x pt-12">
      ...
      <SubHeading as="p" className="mx-auto mt-6 max-w-lg px-2">
        Everything here is true at launch and written to stay true. If a
        question is not answered, the garden itself is the quickest way to
        find out.
      </SubHeading>
      <div className="mt-8 mb-12 flex w-full flex-col justify-center gap-4 px-4 sm:flex-row">
        <Button as="a" href={site.openUrl} variant="primary" className="w-full sm:w-auto">
          Open on mobile
        </Button>
      </div>
      <DivideX />
