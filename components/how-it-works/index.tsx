...
const Panel = ({ render }: { render: (typeof renders)[keyof typeof renders] }) => (
...
export const HowItWorks = () => {
  const tabs = [
    {
      title: "Arrive in a garden already full",
      description:
        "You spawn by the potting shed, inside the walls. Every room you walk into has things in it that other people placed.",
      icon: FirstIcon,
      id: "arrive",
      skeleton: <Panel render={renders.spawn} />,
    },
    {
      title: "Plant one thing a day",
      description:
        "Open the wheel, pick a prop, aim at open ground and tap. One placement per person per day, so the garden fills at the pace of visits.",
      icon: SecondIcon,
      id: "plant",
      skeleton: <Panel render={renders.plots} />,
    },
    {
      title: "It stays, with your name on it",
      description:
        "Placements are permanent and attributed. Tap any plant, stone or bench in the garden and see who put it there.",
      icon: ThirdIcon,
      id: "stays",
      skeleton: <Panel render={renders.stoneCircle} />,
    },
  ];
  ...
  return (
    <Container className="border-divide border-x">
      <div id="how-it-works" className="flex flex-col items-center pt-16">
        <Badge text="How it works" />
        <SectionHeading className="mt-4">Three steps, one a day</SectionHeading>

        <SubHeading as="p" className="mx-auto mt-6 max-w-lg">
          There is no build mode and no menu to learn. You walk in, you leave
          one thing, and the garden is a little more full than you found it.
        </SubHeading>
        {/* Desktop Tabs */}
